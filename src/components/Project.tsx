...
function Project() {
    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                <a href="https://drive.google.com/file/d/1Inx8khapuG4iSa_fdsTtBgMF5FewwgvM/view" target="_blank" rel="noreferrer"><img src={mock02} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://drive.google.com/file/d/1VIAsQQQbJIb_u29tocOb6LLBrnBjkgW7/view?usp=sharing" target="_blank" rel="noreferrer"><img src={mock03} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://drive.google.com/file/d/1vHayOYm1Ct-z1nT4CApUJBH5ZEd-jzbR/view?usp=sharing" target="_blank" rel="noreferrer"><img src={mock04} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://drive.google.com/file/d/1M9EOlroY0dbNTqPo8014_EiBnl46PO7i/view?usp=sharing" target="_blank" rel="noreferrer"><img src={mock07} className="zoom" alt="thumbnail" width="100%"/></a>
